...
1. Check out the [issues](https://github.com/rpearce/hex/issues)
...
1. Add the upstream project (this one) as a git remote:
    ```
    $ git remote add upstream git@github.com:rpearce/hex.git
    $ git fetch upstream
...
1. When all is merged, pull down the upstream changes to your main branch
    ```
    $ git fetch upstream
